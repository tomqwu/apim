...
# Study publication intake: Add local-first interactive Kong assessment
...
- **Intake ID:** `INTAKE-20260821-kong-interactive-assessment`
- **Canonical workflow state:** `INTAKE`
- **Checkpoint location:** local ignored checkpoint `.study-workflow/checkpoints/intake-20260821-kong-interactive-assessment.json`; mirror to the draft PR
- **Last transition and reason:**
- **Requested outcome:** Publish a reviewed repository change for “Add local-first interactive Kong assessment” following the canonical workflow.
- **Current authorized instruction:** Publish a public-safe interactive workshop flow that captures phase answers locally and produces an evidence-bounded assessment summary with portable exports.
...
- **Type:** chat
- **Public-safe title:** Add local-first interactive Kong assessment
- **Stable reference:** User request for interactive assessment capture on the guided GitHub Pages presentation
- **Provider/provenance:**
...
- **Decision question:** Can the guided Kong journey collect structured workshop evidence and produce a more accurate readiness assessment without transmitting private inputs or overstating evidence?
