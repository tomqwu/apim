...
Stable identifiers are navigation aids, not evidence. Before a participant approves, amends, rejects, or holds an item, the interaction layer links the identifier to the exact canonical section that defines its meaning and decision use. Opening a reference must not change the participant's local assessment answers. The linked material supplies context and evidence requirements; it does not prove that a criterion has passed.

| Selectors | Plain-language meaning | Reference path | Reference heading | Decision use |
|---|---|---|---|---|
| KGE | Kong Guided Evaluation meeting and assessment contract | docs/49-kong-guided-evaluation-facilitator-guide.md | Local interactive assessment contract | Review what meeting answers can and cannot authorize. |
| E0; E1; E2; E3; E4 | Evidence levels from assertion through representative pilot | docs/03-assessment-methodology.md | Evidence levels and claim contract | Check the evidence floor and claim ceiling before interpreting a decision. |
| KP-SMH1 | Kong self-managed hybrid target | docs/47-kong-enterprise-platform-strategy.md | Bounded target option and non-goals | Review the exact target boundary and non-goals before approving it for proof. |
| KGE-AUTH; KGE-AUTH-01..KGE-AUTH-05 | Bounded authorization decisions | docs/48-kong-guided-evaluation.md | Bounded authorization | Review the five separate decisions the meeting may authorize or hold. |
| GTM; GTM-01..GTM-09 | Stated target operating-model inputs | docs/48-kong-guided-evaluation.md | Stated target operating model | Confirm or amend the operating assumptions before comparing options. |
| EAG; EAG-01..EAG-04 | Early assessment gates | docs/48-kong-guided-evaluation.md | Four early assessment gates | Resolve multicloud, exit, cost, and security-adjunct scope before bounded authorization. |
| GSA; GSA-01 | Traceable by Harness security-adjunct hypothesis | docs/48-kong-guided-evaluation.md | Traceable by Harness security-adjunct feasibility | Decide whether the third-party adjunct enters bounded study without awarding native Kong credit. |
| GEP; GEP-01..GEP-07 | Target-aligned proof workstreams | docs/48-kong-guided-evaluation.md | Seven-workstream target-aligned proof programme | Review the proof scope, artifact, threshold, reviewer, and stop rule before funding work. |
| GEC; GEC-01..GEC-08; GEC-19 | Supplied architecture and delivery comparison inputs | docs/48-kong-guided-evaluation.md | Supplied comparison input: architecture and delivery | Trace architecture and delivery claims back to their current evidence ceiling. |
| GEC-09..GEC-15; GEC-20 | Supplied management, experience, and artificial-intelligence comparison inputs | docs/48-kong-guided-evaluation.md | Supplied comparison input: management, experience, and AI | Trace management, developer-experience, and artificial-intelligence claims before promoting them. |
| GEC-16..GEC-18 | Supplied economics and evidence-ceiling inputs | docs/48-kong-guided-evaluation.md | Supplied comparison input: economics and evidence ceiling | Review commercial and scale assertions without treating them as measured results. |
| GRS; GRS-01..GRS-06 | Proposed governed re-score dimensions | docs/48-kong-guided-evaluation.md | Proposed governed re-score | Review the new criteria and unknown ranges before authorizing a re-score. |
| GEW; GEW-01..GEW-08 | Supplied scorecard weights | docs/48-kong-guided-evaluation.md | Supplied weighting model | Confirm historical weights before interpreting the supplied score. |
| GEO; GEO-KONG; GEO-APIGEE; GEO-MULE; GEO-APIM | Conditional option archetypes | docs/48-kong-guided-evaluation.md | Conditional option archetypes | Inspect the conditions that could narrow Kong or reopen option selection. |
| GEB; GEB-01..GEB-03 | Distinct operating boundaries | docs/48-kong-guided-evaluation.md | Operating boundaries to keep distinct | Keep control-plane custody, runtime placement, and policy authority separate. |
| KMC; KMC-1; KMC-3 | Kong multicloud option records | docs/44-kong-multicloud-study-roadmap.md | Bounded Kong option register | Compare the bounded multicloud custody options before choosing a foundation. |
...
| MULE; MULE-2 | Mule responsibility decomposition | docs/35-mule-migration-strategy.md | Mechanism analysis: decompose before selecting a target | Classify Mule responsibilities and durable state before choosing a destination. |
