...
13. When stakeholders choose a planning direction before comparative evidence closes, record it explicitly, concentrate reversible proof on that target, and preserve counterfactual, stop, custody-switch, and true-exit conditions instead of relabelling preference as observed fit.
...
The [Kong enterprise platform deployment strategy](47-kong-enterprise-platform-strategy.md) records the subsequent stakeholder direction to proceed with Kong and translates it into one leading self-managed-hybrid target, explicit platform ownership, realistic cases, outcome measures, a 0–18 month evidence sequence, a Konnect custody benchmark, and a separate non-Kong exit. It changes execution focus without upgrading the evidence state of the earlier hypothesis or roadmap; only exact-option, contract, E3, E4, operating, economic, and exit evidence can authorize scale.
...
| 1. Principal content baseline | Implemented; independent acceptance open | Substantive, contract-governed public study corpus | Principal-study standard and template, 43 deep studies, reference case, public failure casebook, canonical industry-problem taxonomy, industry-practice and realistic-scenario guide, Kong multicloud study roadmap, Kong platform deployment strategy, symmetric dossiers, point-of-use figures, decision-grade protocols, machine-readable remediation workflow | Repository validators and independent principal review pass; material PCR findings are disposed with committed closure evidence—not merely marked complete |
...
| Research | `research/`, [industry-problem taxonomy](43-api-management-industry-problems.md), [industry practices](45-api-management-industry-practices.md), [Kong multicloud study roadmap](44-kong-multicloud-study-roadmap.md) | Decision-bearing source promotion, problem-to-practice-to-proof portfolio, realistic challenge cases, candidate-specific workstreams without priority leakage, criterion linkage, freshness monitoring, entitlement/version tracking and archived evidence references |
