...
The stakeholder planning direction now favors Kong, and the [Kong enterprise platform deployment strategy](../docs/47-kong-enterprise-platform-strategy.md) supplies the leading self-managed hybrid physical target, state/trust boundaries, operating ownership, realistic failures, and proof gates. The older standalone Kong views remain pre-direction hypotheses rather than approved production designs. Alternative-platform views remain required counterfactual and true-exit evidence; the stakeholder direction does not make an unexecuted physical view observed fact.
